    ...
    <main class="ps-0 ps-md-5 flex-grow-1">
      <div class="container-fluid mt-1 mb-4">
        ...
        <div class="w-75 d-flex justify-content-start">
          <form action="submitEnrollClass.php" method="post">
            <ul class="mt-4 mb-4">';
    print "<li><h5>" . $_SESSION['manage']['name'] . "</h5></li>";
    print '</ul>
            <div class="mt-2 float-start">
              <input name="student_id" type="number" min="0" max="9999999" class="form-control" placeholder="Enter Student ID" required>
              <button type="submit" name="course_id" class="btn btn-danger button mt-2" value="' . $classid . '">Confirm Add</button>
